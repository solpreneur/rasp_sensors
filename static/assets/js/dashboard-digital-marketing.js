...
// Temperature day  chart homepage
  ...
  function loadCharts(){
    var url = 'http://127.0.0.1:8000/reading/temperature/';
    ...
    var url = 'http://127.0.0.1:8000/reading/humidity/';
    $.getJSON(url, function(response) {
    ...
    var url = 'http://127.0.0.1:8000/reading/co2/';
    $.getJSON(url, function(response) {
    ...
    var url = 'http://127.0.0.1:8000/read-day/co2/';
    $.getJSON(url, function(response) {
    ...
    var url = 'http://127.0.0.1:8000/read-day/temperature/';
    $.getJSON(url, function(response) {
    ...
    var url = 'http://127.0.0.1:8000/read-day/humidity';
    $.getJSON(url, function(response) {
